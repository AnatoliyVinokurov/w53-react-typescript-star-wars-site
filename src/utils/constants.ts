...
import { Characters, HeroContext, Item } from './types';
...
export const navItems: Array<Item> = [{ title: 'Home', route: 'home' },
...
export const StarWarsContext = React.createContext<HeroContext>({hero: defaultHero});